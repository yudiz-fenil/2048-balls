...
class LogoPrefab extends Phaser.GameObjects.Container {
	...
	constructor(scene, x, y) {
		...
		// bl4
		const bl4 = scene.add.image(65, 35, "bl4");
		container_balls.add(bl4);

		// bl0
		const bl0 = scene.add.image(-91, 39, "bl0");
		container_balls.add(bl0);

		// bl2
		const bl2 = scene.add.image(-249, 54, "bl2");
	...
	ballsAnimation = () => {
		for (let i = 0; i < this.container_balls.length; i++) {
